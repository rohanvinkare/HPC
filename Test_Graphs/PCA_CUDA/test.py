...
# Load data
df = pd.read_csv('/home/rohan-vinkare/Collage/1_Sem_6/HPC/hpc_project/HPC-5/Test_Graphs/PCA_CUDA/pca_cuda.csv')
...
plt.title('PCA Total Execution Time\n(CUDA Implementation)', pad=20)
plt.grid(True, linestyle='--', alpha=0.7)
plt.savefig('pca_cuda_total_time.png')
plt.close()
...
plt.title('PCA Operation Time Breakdown (CUDA)', pad=20)
plt.grid(True, linestyle=':', alpha=0.5)
plt.savefig('pca_cuda_time_breakdown.png', bbox_inches='tight')
plt.close()
...
plt.xlabel('Number of Images', fontweight='bold')
plt.ylabel('Time (ms)', fontweight='bold')
plt.title('PCA Time Complexity Analysis (CUDA)', pad=20)
plt.legend()
plt.grid(which='both', linestyle='--', alpha=0.5)
plt.savefig('pca_cuda_complexity_analysis.png')
plt.close()

# 4. Bottleneck Operations Growth
bottlenecks = {
    'trainPCAModel_time': 'Train Model',
    'computeMean_time': 'Compute Mean',
...
plt.xlabel('Number of Images', fontweight='bold')
plt.ylabel('Time (ms)', fontweight='bold')
plt.title('PCA Bottleneck Operations Growth (CUDA)', pad=20)
plt.legend()
plt.grid(True, linestyle='--', alpha=0.5)
plt.savefig('pca_cuda_bottlenecks.png')
plt.close()
...
plt.ylabel('Total Time (seconds)', fontweight='bold')
plt.title('Memory Usage vs Execution Time (CUDA)', pad=20)
plt.grid(True, linestyle='--', alpha=0.5)
plt.savefig('pca_cuda_memory_vs_time.png')
plt.close()
...
plt.title('PCA Efficiency: Time per Image (CUDA)', pad=20)
plt.grid(True, linestyle='--', alpha=0.5)
plt.savefig('pca_cuda_time_per_image.png')
plt.close()
...
plt.title('PCA Parallel Efficiency (CUDA)', pad=20)
plt.legend()
plt.grid(True, linestyle='--', alpha=0.5)
plt.savefig('pca_cuda_parallel_efficiency.png')
plt.close()

print("All CUDA performance graphs generated successfully:")
print("- pca_cuda_total_time.png")
print("- pca_cuda_time_breakdown.png")
print("- pca_cuda_complexity_analysis.png")
print("- pca_cuda_bottlenecks.png")
print("- pca_cuda_memory_vs_time.png")
print("- pca_cuda_time_per_image.png")
print("- pca_cuda_parallel_efficiency.png")